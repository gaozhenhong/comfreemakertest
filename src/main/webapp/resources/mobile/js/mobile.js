...
xiuxiu.lightEditor = xiuxiu.lightEditor || {
    url: "../../resources/meiTu/flash/PhotoEditor.swf?version=201405281145",
    base: "http://open.web.meitu.com/sources/light/",
    width: "528",
    height: "385",
    type: 1
};
xiuxiu.lightPuzzle = xiuxiu.lightPuzzle || {
    url: "../../resources/meiTu/flash/CollagePlugin.swf?version=201305211645",
    base: "http://open.web.meitu.com/sources/puzzle/",
    width: "528",
    height: "470",
    type: 2
};
xiuxiu.richEditor = xiuxiu.richEditor || {
    url: "../../resources/meiTu/flash/Main.swf?v=2.6.103",
    base: "http://xiuxiu.web.meitu.com/",
    width: "100%",
    height: "100%",
    type: 3
};
xiuxiu.daitoutie = xiuxiu.daitoutie || {
    url: "../../resources/meiTu/flash/FacePhoto.swf?version=201304251419",
    base: "http://open.web.meitu.com/sources/daitoutie/",
    width: "568",
    height: "478",
    type: 4
};
xiuxiu.avatarEditor = xiuxiu.avatarEditor || {
    url: "../../resources/meiTu/flash/avatar.swf?version=201405071529",
    base: "http://open.web.meitu.com/sources/avatar/",
    width: "700",
    height: "435",
    type: 5
};
xiuxiu.batchEditor = xiuxiu.batchEditor || {
    url: "../../resources/meiTu/flash/plugin.swf?version=201405281142",
    base: "http://xiuxiu.web.meitu.com/plugin/batch/",
    width: "700",
    height: "435",
    type: 6
};
...
xiuxiu.embedSWF = function(b, c, f, m, e) {
    ...
    swfobject.embedSWF(a, xiuxiu.container, f, m, g, "http://open.web.meitu.com/sources/expressInstall.swf", h, l, xiuxiu.attributes);
    xiuxiu.swfs.push({
